...
<body background ="<?= base_url('template') ?>">
   ...
   <p> <h3>Data User</h3></p>
        ...
        <table class="table table-striped">
            ...
            <?php foreach($m_data as $row):?> 
                <tr>
                    ...
                    <td><?= $row->email;?></td>
                    <td>
                        <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?= $row->id;?>" data-nama="<?= $row->nama;?>" data-email="<?= $row->email;?>">Edit</a>
    ...
    <!-- Modal Add User-->
    <form action="<?= base_url('data_user/save/') ?>" method="post">
    ...
    <form action="<?= base_url('data_user/update/') ?>" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control name" name="nama">
                </div>
